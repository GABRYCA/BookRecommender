...
/**
 * Thread per gestire una singola connessione client.
 */
public class ServerThread extends Thread {
    ...
    public void run() {
        try {
            // Inizializza gli stream per la comunicazione
            ...
            // Ciclo principale per gestire le richieste
            ...
            while (running) {
                ...
                switch (comando) {
                    ...
                    default -> inviaRisposta("ERRORE", "Comando non riconosciuto: " + comando);
                }
            }
    ...
    private void gestisciRegistrazione() throws IOException, ClassNotFoundException, SQLException {
        ...
        try {
            ...
            // Gestione errori specifici SQL come violazioni di unicità
